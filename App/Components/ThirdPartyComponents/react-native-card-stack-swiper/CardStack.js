...
class CardStack extends Component {
  ...
  _nextCard(direction, x, y, duration = 400) {
    ...
    const index = loop
      ? this.mod(nextCard - 2, cards.length)
      : nextCard - 2;
  ...
  render() {
    ...
    const {drag, dragDistance, cardA, cardB, topCard, sindex, cardC} =
      this.state;
    ...
    return (
      ...
      >
        ...
        >
          ...
          sindex !== this.state.cards.length + 1
            ? cardC
            : cardB}
        </Animated.View>
        <Animated.View
...
CardStack.propTypes = {
  ...
  renderNoMoreCards: PropTypes.oneOfType([
    PropTypes.func,
    PropTypes.element,
  ]),
